...
namespace TinhVan.Web
{
    ...
    public class SecurityHttpModule : IHttpModule
    {
        ...
        private void AcquireRequestState(Object sender, EventArgs e)
        {
            ...
            //if (HttpContext.Current.Session["ListUrl"] == null)
            //    HttpContext.Current.Session["ListUrl"] = new List<string>();
            //List<String> lstURL = (List<string>)HttpContext.Current.Session["ListUrl"];
            //if (!lstURL.Contains(Request.Url.AbsolutePath))
            //    lstURL.Add(Request.Url.AbsolutePath);
            ...
            //    {
            //        Uri oUri = new Uri(Request.ServerVariables["HTTP_REFERER"]);
            //        if ((oUri.AbsolutePath == node.ParentNode.Url) | (oUri.AbsolutePath == node.Url))
            //        {
            //            return;
            //        }
            //    }
            ...
            if (allow == false)
            {
                Response.Redirect(FormsAuthentication.LoginUrl + "?notaccess=1");
