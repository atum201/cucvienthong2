                                    ...
                                    <table width="100%" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" align="left" style="width: 66%; text-align: left">
                                                <div style="float: left;width:70.2%;margin-right:10px;">
                                                    <cc1:ComboBox ID="ddlTenSanPham" runat="server" AutoPostBack="True" Width="59.5%" BackColor="#FFFFC0" 
                                        ...
                                        <tr>
                                            <td align="left" style="width: 33%;" class="caption">
                                                K&yacute; hi&#7879;u</td>
                                            <td valign="top" align="left" style="width: 66%; text-align: left">
                                                <asp:TextBox ID="txtKyHieu" runat="server" Width="70%" MaxLength="255" BackColor="#FFFFC0" ></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="width: 33%;" class="caption">
