<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NhapLieu_CN_ThongBaoPhi.aspx.cs"
    Inherits="WebUI_NhapLieu_CN_ThongBaoPhi" Title="Thông báo lệ phí" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <rjs:popcalendar id="PopCalendar1" runat="server" control="txtNgayKy" controlfocusonerror="true"
                            ...
                            requireddatemessage="Bạn phải nhập ngày ký" separator="/" showerrormessage="False"></rjs:popcalendar>
                        (dd/mm/yyyy)
