<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_CB_QuanLy_PHTC_ChiTiet.ascx.cs" Inherits="UserControls_uc_QL_CongBo_PHTC" %>
<table border="0" width="100%">
    ...
    <tr>
        ...
        <td colspan="2">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server">Tìm kiếm</asp:LinkButton></td>
    </tr>
    ...
    <tr style="color: #000000">
        ...
        <td>
            &nbsp;<asp:RadioButtonList ID="rbHinhThuc" runat="server" RepeatDirection="Horizontal">
                ...
                <asp:ListItem Value="0">Tự đ&#225;nh gi&#225; PH</asp:ListItem>
