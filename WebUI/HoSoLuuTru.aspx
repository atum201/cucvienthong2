<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HoSoLuuTru.aspx.cs" Inherits="WebUI_HoSoLuuTru" %>
                ...
                <td style="width: auto; height: 24px;">
                    ...
                    <asp:DataList ID="dtlFile" runat="server" OnItemDataBound="dtlFile_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lnkXoaFile" CommandName="Delete" runat="server" OnClick="LinkButton2_Click">Xóa</asp:LinkButton>
                        </ItemTemplate>
                    </asp:DataList>
                </td>
            </tr>
