<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.master" AutoEventWireup="true"
    CodeFile="NhapLieu_CN_SanPhamQuanLy.aspx.cs" Inherits="WebUI_NhapLieu_CN_SanPhamQuanLy" Theme="default"%>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="margin: 10px auto 10px 10px">
        <span style="font-family: Arial; font-weight: bold;">NHẬP HỒ SƠ CHỨNG NHẬN &gt;&gt<%--<a
                    ...
                    <asp:GridView ID="gvSanPham" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="T&#234;n sản phẩm">
                                <ItemTemplate>
                                <a href="NhapLieu_CN_SanphamChiTiet.aspx?direct=NhapLieu_CN_SanPhamQuanLy.aspx&Action=Edit&HoSoId=<%# Request["HoSoID"].ToString() %>&SanPhamID=<%# Server.UrlEncode(Eval("ID").ToString()) %>&TrangThaiID=13&UserControl=CN_HoSoDen&UserControlHS=<%# Request["UserControlHS"] %>">
                                    <%# Eval("TenSanPham")%>
                                </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:GridView ID="gvThongBaoNopTien" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Số th&#244;ng b&#225;o lệ ph&#237;">
                            ...
                            <ItemTemplate>
                                <a href="#" onclick=" return popCenter('NhapLieu_CN_ThongBaoNopTien.aspx?TrangThaiID=<%# Eval("TrangThaiID") %>&action=edit&HoSoID=<%# Request["HoSoID"].ToString() %>&ThongBaoLePhiID=<%# Eval("ID")%>','CN_ThongBaoPhi_TaoMoi',800,600);"/>
                ...
                <asp:GridView ID="gvPhi" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Số th&#244;ng b&#225;o lệ ph&#237;">
                            <ItemStyle Font-Underline="False" />
                            <ItemTemplate>
                                <a href="#" onclick=" return popCenter('NhapLieu_CN_ThongBaoPhi.aspx?TrangThaiID=<%# Eval("TrangThaiID") %>&action=edit&HoSoID=<%# Request["HoSoID"].ToString() %>&ThongBaoLePhiID=<%# Eval("ID")%>','CN_ThongBaoPhi_TaoMoi',800,600);" />
                                <%# Eval("SoGiayThongBaoLePhi")%>
                                </a>
                            </ItemTemplate>
                        </asp:TemplateField>
