<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.master" AutoEventWireup="true"
    ...
    Title="Tra cứu thông tin người nộp hồ sơ" Theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin: 10px auto 10px 10px;">
        <strong>TRA CỨU >> TRA CỨU NGƯỜI NỘP HỒ SƠ</strong>
    </div>
                        ...
                        <table align="center" border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td align="right" style="text-align: left" width="130">
                                    Người nộp hồ sơ</td>
                                <td align="left" width="320">
                                    <asp:TextBox ID="txtNguoiNop" runat="server" MaxLength="255" Width="270px"></asp:TextBox></td>
                                <td align="right" width="130">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="4" valign="top">
                                    <cc1:PagingGridView ID="gvHoSo" AllowSorting="True" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NguoiNopHoSo" HeaderText="Người nộp hồ sơ" SortExpression="NguoiNopHoSo" />
                                            <asp:BoundField DataField="NguoiThamDinh" HeaderText="Người thẩm định" />
