<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.master" AutoEventWireup="true" CodeFile="HoSo_Delete_SanPham.aspx.cs" Inherits="WebUI_CN_HoSo_Delete_SanPham" Title="Delete San Pham" Theme="Default"%>
<%@ Register Src="../UserControls/uc_CN_HoSoSanPham_DeleteSP.ascx" TagName="uc_CN_HoSoSanPham_DeleteSP"
    TagPrefix="uc1" %>
