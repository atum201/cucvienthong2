<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.master" AutoEventWireup="true"
    CodeFile="NhapLieu_CN_HoSoQuanLy.aspx.cs" Inherits="WebUI_NhapLieu_CN_HoSoQuanLy"
    Title="Nhập hồ sơ chứng nhận" %>
                    ...
                    <cc1:PagingGridView ID="gvHoSo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Số hồ sơ">
                                <itemtemplate>
                                    <a href="NhapLieu_CN_SanPhamQuanLy.aspx?HoSoId=<%# Server.UrlEncode(Eval("ID").ToString()) %>&TrangThaiId=<%# Server.UrlEncode(Eval("TrangThaiID").ToString()) %>&UserControl=CN_HoSoDen"
                                        style="float: left">
                                        <%# Eval("SoHoSo") %>
                                    </a>
                                    <div runat="server" id="View" style="float: right;" visible="true">
                                        <a href="NhapLieu_CN_HoSoChitiet.aspx?id=<%# Server.UrlEncode(Eval("ID").ToString())%>&TrangThaiId=<%# Server.UrlEncode(Eval("TrangThaiID").ToString())%>&UserControl=CN_HoSoDen">
